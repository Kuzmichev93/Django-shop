...
SECRET_KEY = 'django-insecure-ntzm@-zd1t)_)0uni1o!(bdyet(=w*nvrx=zw2=^6k1g!9u!0x'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db50.sqlite3', #BASE_DIR / 'db.sqlite3'
    }
}
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR,'cache_my')
    }
}
